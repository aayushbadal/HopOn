...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    $delete_sql = "DELETE FROM vehicle_lists WHERE id = ?";
...
<section id="vehicle" class="vehicle-section">
            ...
            <div class="vehicle-card">
                ...
                <div class="vehicle-details">
                    <div class="vehicle-info">
                      ...
                      <!-- Delete button -->
                      <form action="manage_bus.php" method="POST" style="margin-top: 10px;">
                        <input type="hidden" name="delete_id" value="<?= $vehicle['id'] ?>">
    ...
    <form action="manage_bus.php" method="POST" id="add-form">
        ...
        <div class="add-group">
            ...
            <input type="text" name="v-no" id="v-no" placeholder="Enter the number of vehicle" required />
        </div>

        <div class="add-group">
            <label for="">Facilities</label>
            <input type="text" name="facility" id="facility" placeholder="Enter facilities for riders" />
        </div>

        <div class="add-group">
            <label for="">Driver Name</label>
            <input type="text" name="d-name" id="d-name" placeholder="Enter driver's name" required />
        </div>

        <div class="add-group">
            <label for="">Driver Phone Number</label>
            <input type="text" name="d-no" id="d-no" placeholder="Enter driver's phone number" required />
        </div>


        <button type="submit" class="add-form-btn">Add Vehicle</button>
    </form>
</div>
